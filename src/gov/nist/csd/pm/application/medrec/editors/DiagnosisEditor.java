 ...
 *
 */
public class DiagnosisEditor extends Editor implements ActionListener{
	...
	public DiagnosisEditor(String theMrn, int nSimPort, String sSessId, String sProcId, boolean bDebug) {
		...
		btnViewAllDiagnoses = new JButton("View All Diagnoses");
		springLayout.putConstraint(SpringLayout.NORTH, btnViewAllDiagnoses, 6, SpringLayout.SOUTH, panel_1);
		springLayout.putConstraint(SpringLayout.WEST, btnViewAllDiagnoses, 6, SpringLayout.EAST, btnSearch);
		btnViewAllDiagnoses.addActionListener(new ActionListener(){
			@Override
			public void actionPerformed(ActionEvent e){
				
			}
		});
		//getContentPane().add(btnViewAllDiagnoses);
		...
		buildReadAllDocument(new ReadAllDocument("Diagnosis", this)).setVisible(true);
	}
	
	public ReadAllDocument buildReadAllDocument(ReadAllDocument reader){
		//ReadAllDocument reader = new ReadAllDocument("Diagnosis", DiagnosisEditor.this);
		reader.setTitle("Diagnoses");
		System.out.println("Diagnoses");

		String container = mRecMrn + "-Diagnoses";
		...
		for(int j = 0; j < newResults.size(); j++){
			...
			if(sHandle == null){
				/*JOptionPane.showMessageDialog(Diagnosis.this,
...
//			JOptionPane.showMessageDialog(DiagnosisEditor.this, "There are no diagnoses");
//		}else{
...
//		}
	...
	public void setPropsWithAllFields(String first, String mi, String last,
			String ssn, String cmd, String dob, String doc, String mrn, String date, String Diagnosis){
		...
		myEditorPane.setText(Diagnosis);
	}
	
	public void search(){
		search = new SearchEngine(syscaller, this);
		search.addItems("Diagnoses");
		search.addItems("Diagnosis Drafts");
	...
	class SaveDraftAlt extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e){
			...
			String cont1 = mRecMrn + "-DraftDiagnoses";
			String cont2 = "PatDiagDrafts";
			...
			if (mrnField.getText().length() == 0) {
				...
				if(slast.length() <= 2){
					JOptionPane.showMessageDialog(DiagnosisEditor.this, "You must have a patient name");
					return;
				}
	...
	private JButton btnViewAllDiagnoses;
	...
	class SubmitToDiagnosis extends AbstractAction{
		...
		public void actionPerformed(ActionEvent e){
			...
			if(sObjName.length() == 0){
				...
				String cont1 = mRecMrn + "-Diagnoses";
				String cont2 = "PatDiag";
				String sContainers = "b|" + cont1 + ",b|" + cont2;
				...
				String sProp2 = "DraftDiagnoses=" + mRecMrn;
